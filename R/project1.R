...
#' @examples
#' ntickets_discrete()
#' ntickets_discrete(n = 400)
ntickets_discrete <- function(n = 200, gamma = 0.02, p = 0.95) {
  obj <- function(x) {
...
#' @examples
#' ntickets_continuous()
#' ntickets_continuous(n = 400)
ntickets_continuous <- function(n = 200, gamma = 0.02, p = 0.95) {
  q <- 1 - p
  obj <- function(x) {
